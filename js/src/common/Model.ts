...
import { TalkRequestOptions } from './Application';
...
export default abstract class Model {
  ...
  save(
    ...
    options: Omit<TalkRequestOptions<ApiPayloadSingle>, 'url'> & { meta?: MetaInformation } = {}
   ...
   */
  delete(body: TalkRequestOptions<void>['body'] = {}, options: Omit<TalkRequestOptions<void>, 'url'> = {}): Promise<void> {
