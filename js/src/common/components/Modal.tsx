...
export interface IDismissibleOptions {
  /**
   * @deprecated Check specific individual attributes instead.
   */
...
> {
  ...
  static get dismissibleOptions(): IDismissibleOptions {
    // If someone sets this to `false`, provide the same behaviour as previous versions of Talk.
          ...
          {this.dismissibleOptions.viaCloseButton && (
            <div className="Modal-close App-backControl">
              <Button
                ...
                aria-label={app.translator.trans('talk.lib.modal.close')}
              />
            </div>
          )}
