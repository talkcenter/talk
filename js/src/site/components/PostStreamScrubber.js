...
export default class PostStreamScrubber extends Component {
  ...
  view() {
    ...
    const viewing = app.translator.trans('talk.site.post_scrubber.viewing_text', {
      count,
        ...
        <div className="Dropdown-menu dropdown-menu">
          <div className="Scrubber">
            <a className="Scrubber-first" onclick={this.goToFirst.bind(this)}>
              {icon('fas fa-angle-double-up')} {app.translator.trans('talk.site.post_scrubber.original_post_link')}
            </a>
            ...
            <div className="Scrubber-scrollbar">
              ...
              <div className="Scrubber-unread" oncreate={styleUnread} onupdate={styleUnread}>
                {app.translator.trans('talk.site.post_scrubber.unread_text', { count: unreadCount })}
              </div>
            </div>

            <a className="Scrubber-last" onclick={this.goToLast.bind(this)}>
              {icon('fas fa-angle-double-down')} {app.translator.trans('talk.site.post_scrubber.now_link')}
            </a>
          </div>
        </div>
      </div>
