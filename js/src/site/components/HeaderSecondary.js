    ...
    if (app.site.attribute('showLanguageSelector') && Object.keys(app.data.locales).length > 1) {
      ...
      items.add(
        ...
        <SelectDropdown
          ...
          accessibleToggleLabel={app.translator.trans('talk.site.header.locale_dropdown_accessible_label')}
        >
          {locales}
        </SelectDropdown>,
        20
    ...
    if (app.session.user) {
      ...
      if (app.site.attribute('allowSignUp')) {
        items.add(
          ...
          <Button className="Button Button--link" onclick={() => app.modal.show(SignUpModal)}>
            {app.translator.trans('talk.site.header.sign_up_link')}
          </Button>,
          10
        );
      }
      ...
      items.add(
        ...
        <Button className="Button Button--link" onclick={() => app.modal.show(LogInModal)}>
          {app.translator.trans('talk.site.header.log_in_link')}
        </Button>,
        0
      );
    }
