    ...
    if (this.posts.length === 0 && !this.loading) {
      return (
        <div className="PostsUserPage">
          <Placeholder text={app.translator.trans('talk.site.user.posts_empty_text')} />
        </div>
      );
    }
      ...
      footer = (
        <div className="PostsUserPage-loadMore">
          <Button className="Button" onclick={this.loadMore.bind(this)}>
            {app.translator.trans('talk.site.user.posts_load_more_button')}
          </Button>
        </div>
      );
    }
          ...
          {this.posts.map((post) => (
            <li>
              <div className="PostsUserPage-discussion">
                {app.translator.trans('talk.site.user.in_discussion_text', {
