...
export default class DiscussionComposer extends ComposerBody {
  static initAttrs(attrs) {
    ...
    attrs.placeholder = attrs.placeholder || extractText(app.translator.trans('talk.site.composer_discussion.body_placeholder'));
    attrs.submitLabel = attrs.submitLabel || app.translator.trans('talk.site.composer_discussion.submit_button');
    attrs.confirmExit = attrs.confirmExit || extractText(app.translator.trans('talk.site.composer_discussion.discard_confirmation'));
    attrs.titlePlaceholder = attrs.titlePlaceholder || extractText(app.translator.trans('talk.site.composer_discussion.title_placeholder'));
  ...
  headerItems() {
    ...
    items.add('title', <h3>{app.translator.trans('talk.site.composer_discussion.title')}</h3>, 100);
