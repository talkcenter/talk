    ...
    if (this.state.position === ComposerState.Position.FULLSCREEN) {
      items.add(
        ...
        <ComposerButton
          ...
          title={app.translator.trans('talk.site.composer.exit_full_screen_tooltip')}
      ...
      if (this.state.position !== ComposerState.Position.MINIMIZED) {
        items.add(
          ...
          <ComposerButton
            ...
            title={app.translator.trans('talk.site.composer.minimize_tooltip')}
        ...
        items.add(
          ...
          <ComposerButton
            icon="fas fa-expand"
            title={app.translator.trans('talk.site.composer.full_screen_tooltip')}
      ...
      items.add(
        ...
        <ComposerButton
          icon="fas fa-times"
          title={app.translator.trans('talk.site.composer.close_tooltip')}
