...
export default class Search<T extends SearchAttrs = SearchAttrs> extends Component<T, SearchState> {
  ...
  view() {
    ...
    const searchLabel = extractText(app.translator.trans('talk.site.header.search_placeholder'));
    ...
    return (
      <div
        role="search"
        aria-label={app.translator.trans('talk.site.header.search_role_label')}
        ...
        <div className="Search-input">
          ...
          {shouldShowClearButton && (
            <button
              ...
              aria-label={app.translator.trans('talk.site.header.search_clear_button_accessible_label')}
              type="button"
            >
