...
export default class NewAccessTokenModal<CustomAttrs extends INewAccessTokenModalAttrs = INewAccessTokenModalAttrs> extends Modal<CustomAttrs> {
  ...
  title(): Mithril.Children {
    return app.translator.trans('talk.site.security.new_access_token_modal.title');
  }

  content(): Mithril.Children {
    const titleLabel = app.translator.trans('talk.site.security.new_access_token_modal.title_placeholder');
        ...
        <div className="Form Form--centered">
          ...
          <div className="Form-group">
            <Button className="Button Button--primary Button--block" type="submit" loading={this.loading}>
              {app.translator.trans('talk.site.security.new_access_token_modal.submit_button')}
            </Button>
          </div>
        </div>
      </div>
