...
export default class NotificationList extends Component {
    ...
    return (
      <div className="NotificationList">
        <div className="NotificationList-header">
          <h4 className="App-titleControl App-titleControl--text">{app.translator.trans('talk.site.notifications.title')}</h4>
  ...
  controlItems() {
    ...
    items.add(
      'mark_all_as_read',
      <Tooltip text={app.translator.trans('talk.site.notifications.mark_all_as_read_tooltip')}>
        <Button
          className="Button Button--link"
          data-container=".NotificationList"
          icon="fas fa-check"
          title={app.translator.trans('talk.site.notifications.mark_all_as_read_tooltip')}
    ...
    items.add(
      'delete_all',
      <Tooltip text={app.translator.trans('talk.site.notifications.delete_all_tooltip')}>
        <Button
          className="Button Button--link"
          data-container=".NotificationList"
          icon="fas fa-trash-alt"
          title={app.translator.trans('talk.site.notifications.delete_all_tooltip')}
          onclick={() => {
            if (confirm(app.translator.trans('talk.site.notifications.delete_all_confirm'))) {
  ...
  content(state) {
    ...
    return <div className="NotificationList-empty">{app.translator.trans('talk.site.notifications.empty_text')}</div>;
  }
