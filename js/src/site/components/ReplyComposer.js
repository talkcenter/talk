...
export default class ReplyComposer extends ComposerBody {
  static initAttrs(attrs) {
    ...
    attrs.placeholder = attrs.placeholder || extractText(app.translator.trans('talk.site.composer_reply.body_placeholder'));
    attrs.submitLabel = attrs.submitLabel || app.translator.trans('talk.site.composer_reply.submit_button');
    attrs.confirmExit = attrs.confirmExit || extractText(app.translator.trans('talk.site.composer_reply.discard_confirmation'));
  }
      ...
      .then((post) => {
        ...
        if (app.viewingDiscussion(discussion)) {
          ...
          const viewButton = (
            ...
            >
              {app.translator.trans('talk.site.composer_reply.view_button')}
            </Button>
          );
          alert = app.alerts.show(
            ...
            app.translator.trans('talk.site.composer_reply.posted_message')
          );
        }
