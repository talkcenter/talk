...
export default class NotificationGrid extends Component {
                  ...
                  <td className="NotificationGrid-checkbox">
                    ...
                    >
                      <span className="sr-only">
                        {app.translator.trans('talk.site.settings.notification_checkbox_a11y_label_template', {
  ...
  notificationMethods() {
    ...
    items.add('alert', {
      name: 'alert',
      icon: 'fas fa-bell',
      label: app.translator.trans('talk.site.settings.notify_by_web_heading'),
    });

    items.add('email', {
      name: 'email',
      icon: 'far fa-envelope',
      label: app.translator.trans('talk.site.settings.notify_by_email_heading'),
    });
  ...
  notificationTypes() {
    ...
    items.add('discussionRenamed', {
      ...
      label: app.translator.trans('talk.site.settings.notify_discussion_renamed_label'),
    });
