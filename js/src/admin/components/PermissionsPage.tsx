...
export default class PermissionsPage extends AdminPage {
  headerInfo() {
    return {
      ...
      icon: 'fas fa-key',
      title: app.translator.trans('talk.admin.permissions.title'),
      description: app.translator.trans('talk.admin.permissions.description'),
    };
  }
      ...
      <>
        <div className="PermissionsPage-groups">
          ...
          <button className="Button Group Group--add" onclick={() => app.modal.show(EditGroupModal)}>
            ...
            <span className="Group-name">{app.translator.trans('talk.admin.permissions.new_group_button')}</span>
          </button>
        </div>
