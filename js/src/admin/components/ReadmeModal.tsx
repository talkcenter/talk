...
export default class ReadmeModal<CustomAttrs extends IReadmeModalAttrs = IReadmeModalAttrs> extends Modal<CustomAttrs> {
  ...
  oninit(vnode: Mithril.Vnode<CustomAttrs, this>) {
    ...
    this.extName = this.attrs.extension.extra['talk-extension'].title;
  ...
  title() {
    return app.translator.trans('talk.admin.extension.readme.title', {
        ...
        {this.loading ? (
          ...
          <div>
            {this.readme.content() ? (
              ...
              <Placeholder text={app.translator.trans('talk.admin.extension.readme.no_readme')} />
            )}
          </div>
        )}
      </div>
