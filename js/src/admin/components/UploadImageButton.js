...
export default class UploadImageButton extends Button {
  ...
  view(vnode) {
    ...
    if (app.data.settings[this.attrs.name + '_path']) {
      ...
      return (
        <div>
          ...
          <p>{super.view({ ...vnode, children: app.translator.trans('talk.admin.upload_image.remove_button') })}</p>
        </div>
      );
    } else {
    ...
    return super.view({ ...vnode, children: app.translator.trans('talk.admin.upload_image.upload_button') });
  }
