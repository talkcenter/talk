...
export default class ExtensionData {
   ...
   *
   * @example
   * app.extensionData.for('talk-tags')
   *
   * talk/flags -> talk-flags | acme/extension -> acme-extension
   */
  ...
  /**
   * This function registers your settings with Talk
   *
   ...
   *
   * .registerSetting({
   *   setting: 'talk-flags.guidelines_url',
   *   type: 'text', // This will be inputted into the input tag for the setting (text/number/etc)
   *   label: app.translator.trans('talk-flags.admin.settings.guidelines_url_label')
  ...
  /**
   * This function registers your permission with Talk
   *
   * @example
   *
   * .registerPermission('permissions', {
   *     icon: 'fas fa-flag',
   *     label: app.translator.trans('talk-flags.admin.permissions.view_flags_label'),
