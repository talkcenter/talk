...
use Talk\User\Event\Activated;
use Talk\User\Event\AvatarChanged;
use Talk\User\Event\Deleted;
...
class User extends AbstractModel
{
    ...
    public function getAvatarUrlAttribute(string $value = null)
    {
        if ($value && strpos($value, '://') === false) {
            return resolve(Factory::class)->disk('talk-avatars')->url($value);
        }
