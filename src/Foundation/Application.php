...
class Application
{
    ...
    /**
     * The IoC container for the Talk application.
     *
     * @var Container
     */
    private $container;
    ...
    /**
     * The paths for the Talk installation.
     *
     * @var Paths
     */
    protected $paths;
    ...
    /**
     * Create a new Talk application instance.
     *
    ...
    {
        $config = $this->container->make('talk.config');

        return $config[$key] ?? $default;
    }

    /**
     * Check if Talk is in debug mode.
     *
     * @return bool
     */
    ...
    /**
     * Get the URL to the Talk installation.
     *
     * @param string $path
     * @return string
     */
    ...
    protected function registerBaseBindings()
    {
         ...
         * Use container inside talk instead.
         */
        ...
        $this->container->instance('talk', $this);
        $this->container->alias('talk', self::class);

        $this->container->instance('talk.paths', $this->paths);
        $this->container->alias('talk.paths', Paths::class);
    }
