...
use Talk\Extension\Exception as ExtensionException;
use Talk\Foundation\ErrorHandling as Handling;
...
class ErrorServiceProvider extends AbstractServiceProvider
{
    ...
    {
        $this->container->singleton('talk.error.statuses', function () {
            return [
                // 400 Bad Request
        ...
        $this->container->singleton('talk.error.classes', function () {
            return [
        ...
        $this->container->singleton('talk.error.handlers', function () {
            return [
        ...
        $this->container->singleton(Handling\Registry::class, function () {
            return new Handling\Registry(
                $this->container->make('talk.error.statuses'),
                $this->container->make('talk.error.classes'),
                $this->container->make('talk.error.handlers')
            );
        });
