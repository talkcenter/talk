...
class QueueServiceProvider extends AbstractServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->container->singleton(Factory::class, function (Container $container) {
            return new QueueFactory(function () use ($container) {
                return $container->make('talk.queue.connection');
            });
        });

        // Extensions can override this binding if they want to make Talkcenter use
        // a different queuing backend.
        $this->container->singleton('talk.queue.connection', function (ContainerImplementation $container) {
            $queue = new SyncQueue;
        ...
        // option and force the binary to Talkcenter.
        ...
        $this->container->alias('talk.queue.connection', Queue::class);
    ...
    {
        $this->container->extend('talk.console.commands', function ($commands, Container $container) {
