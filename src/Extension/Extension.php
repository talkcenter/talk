...
use Talk\Extend\LifecycleInterface;
use Talk\Extension\Exception\ExtensionBootError;
...
class Extension implements Arrayable
{
    ...
    /**
     * The IDs of all Talk extensions that this extension depends on.
     *
     * @var string[]
     */
    ...
    /**
     * The IDs of all Talk extensions that this extension should be booted after
     * if enabled.
     *
     * @var string[]
     */
    ...
    protected static function nameToId($name)
    {
        ...
        $package = str_replace(['talk-ext-', 'talk-'], '', $package);
    ...
    /**
     * Get the list of talk extensions that this extension depends on.
     *
    ...
    public function calculateDependencies($extensionSet)
    {
        ...
        $this->optionalDependencyIds = (new Collection(Arr::get($this->composerJson, 'extra.talk-extension.optional-dependencies', [])))
            ->map(function ($key) {
                return static::nameToId($key);
            })
            ->toArray();
    ...
    {
        $icon = $this->composerJsonAttribute('extra.talk-extension.icon');
    ...
    {
        return $this->composerJsonAttribute('extra.talk-extension.title');
    }
    ...
    public function getLinks()
    {
        ...
        return array_merge($links, $this->composerJsonAttribute('extra.talk-extension.links') ?? []);
    }
