...
class Event implements ExtenderInterface
{
    ...
    /**
     * Add a listener to a domain event dispatched by talkcenter or a talk extension.
     *
    ...
    /**
     * Add a subscriber for a set of domain events dispatched by talkcenter or a talk extension.
