...
class Model implements ExtenderInterface
{
     ...
     * @param string $related: The ::class attribute of the model, which should extend \Talk\Database\AbstractModel.
     ...
     *                  like \Talk\User\User for examples of how relationships should be returned.
     *
     * @return self
     */
