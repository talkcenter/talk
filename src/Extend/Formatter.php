...
use Talk\Formatter\Formatter as ActualFormatter;
...
class Formatter implements ExtenderInterface, LifecycleInterface
{
     ...
     * - \Talk\User\User|null $actor. This argument MUST either be nullable, or omitted entirely.
     *
    ...
    {
        $container->extend('talk.formatter', function ($formatter, $container) {
