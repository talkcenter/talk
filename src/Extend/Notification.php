...
class Notification implements ExtenderInterface
{
     ...
     *                          This blueprint should implement \Talk\Notification\Blueprint\BlueprintInterface.
     * @param string $serializer: The ::class attribute of the serializer class.
     *                           This serializer should extend from \Talk\Api\Serializer\AbstractSerializer.
     ...
     *                       This driver should implement \Talk\Notification\Driver\NotificationDriverInterface.
     ...
     * - \Talk\Notification\Blueprint\BlueprintInterface $blueprint
     * - \Talk\User\User[] $newRecipients
     *
    ...
    {
        $container->extend('talk.notification.blueprints', function ($existingBlueprints) {
        ...
        $container->extend('talk.api.notification_serializers', function ($existingSerializers) {
            return array_merge($existingSerializers, $this->serializers);
        });

        $container->extend('talk.notification.drivers', function ($existingDrivers) {
