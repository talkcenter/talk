...
/**
 * A view which renders a HTML skeleton for Talk's frontend app.
 */
class Document implements Renderable
{
     ...
     * @var string
     */
    public $appView = 'talk::frontend.app';
     ...
     * @var string
     */
    public $contentView = 'talk::frontend.content';
    ...
    /**
     * Other variables to preload into the Talkcenter JS.
     *
     * @var array
     */
    public $payload = [];
