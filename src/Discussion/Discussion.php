...
use Talk\Database\ScopeVisibilityTrait;
use Talk\Discussion\Event\Deleted;
use Talk\Discussion\Event\Hidden;
use Talk\Discussion\Event\Renamed;
use Talk\Discussion\Event\Restored;
use Talk\Discussion\Event\Started;
use Talk\Foundation\EventGeneratorTrait;
use Talk\Notification\Notification;
use Talk\Post\MergeableInterface;
use Talk\Post\Post;
...
class Discussion extends AbstractModel
{
     ...
     * completely.)
     *
     * @template T of \Talk\Post\MergeableInterface
