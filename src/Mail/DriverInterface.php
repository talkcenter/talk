 ...
 * using one of Laravel's various email drivers throughout Talkcenter.
 *
 * @public
 */
interface DriverInterface
{
     ...
     * values stored in Talkcenter's settings are "valid" as far as a simple
     ...
     * presence of validation problems with the configured mail driver, Talkcenter
     * will fall back to its no-op {@see \Talk\Mail\NullDriver}.
     */
    ...
    /**
     * Build a mail transport based on Talkcenter's current settings.
     */
