...
class Index
{
    ...
    public function __invoke(Document $document, Request $request)
    {
        ...
        $sortMap = resolve('talk.site.discussions.sortmap');
        ...
        $document->title = $this->translator->trans('talk.site.index.meta_title_text');
        $document->content = $this->view->make('talk.site::frontend.content.index', compact('apiDocument', 'page'));
