...
class Server
{
    ...
    /**
     * Try to boot Talk, and retrieve the app's HTTP request handler.
     *
    ...
    private function cleanBootExceptionLog(Throwable $error)
    {
        ...
        if ($container->has('talk.config') && resolve('talk.config')->inDebugMode()) {
            ...
            echo <<<ERROR
            Talk encountered a boot error ($type)<br />
            <b>$message</b><br />
...
ERROR;
            ...
            echo 'Talkcenter encountered a boot error. Details have been logged to the Talk log file.';
            exit(1);
        }
    }
    ...
    {
        echo 'Talkcenter encountered a boot error. Details have been logged to the system PHP log file.<br />';
